...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form action="" className='flex flex-col max-w-[600px] w-full' method='POST'>
            <div className='p-8'>
            ...
            <textarea name="message" placeholder='Message' cols="30" rows="10" className='bg-[#ccd6f6] p-2'></textarea>
